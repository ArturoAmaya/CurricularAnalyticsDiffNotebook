...
#c.JupyterHub.data_files_path = 'c:\\users\\artut\\anaconda3\\share\\jupyterhub'
...
#  
#  This sets the maximum and default scopes assigned to oauth tokens issued by a
...
#  
#  If callable, will be called with the Spawner as a single argument. Callables
#  may be async.
